...
import {Avatar, Box, IconButton, Stack, Typography, Divider, Button, 
                ...
                <Stack sx={{height: "100%", position:"relative", flexGrow: 1, overflowY: "scroll"}} p={3} spacing={3}>
                    <Stack alignItems={"center"} direction={"row"} spacing={2}>
                        ...
                        <Stack spacing={0.5}>
                            ...
                            <Typography variant="body2" fontWeight={600}>{faker.phone.number()}</Typography>
                        </Stack>
                    </Stack>
                    ...
                    <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
                        <Typography variant="subtile2">Media,Links and Docs</Typography>
                        <Button onClick={() => {
                    ...
                    <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
                        <Stack direction={"row"} alignItems={"center"} spacing={2}>
                            <Star size={21} />
                            <Typography variant="subtile2">Stared Messages</Typography>
                        </Stack>
                        <IconButton onClick={() => {
                    ...
                    <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
                        <Stack direction={"row"} alignItems={"center"} spacing={2}>
                            <Bell size={21} />
                            <Typography variant="subtile2">Mute Notification</Typography>
                        </Stack>
                        <AntSwitch />
                    </Stack>
                    <Divider />
                    <Typography variant="subtile2">1 group in common</Typography>
                    <Stack direction={"row"} spacing={2} alignItems={"center"}>
                        <Avatar src={faker.image.avatar()} />
                        <Stack spacing={0.5}>
                            <Typography variant="subtile2">Java SDC1</Typography>
                            <Typography variant="caption">Code, Sleep, Eat</Typography>
                        </Stack>
                    </Stack>
                    <Divider />
                    <Stack direction={"row"} alignItems={"center"} spacing={2}>
